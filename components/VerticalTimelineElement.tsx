    ...
    return (
        ...
        <>
            ...
            <div className={timelineClass}>
                ...
                <ul className="list-disc ml-[-23px] pl-6 text-[#4f5e71] mt-4 font-[urbanist] font-[500] flex flex-col gap-2 font-[16px] leading-[1.5em]" dangerouslySetInnerHTML={{ __html: description }}></ul>
            </div>
