    ...
    return (
        ...
        <>
            ...
            <div className={timelineClass}>
                ...
                <ul className="list-disc p-1 text-[#4f5e71] mt-4 font-[urbanist] font-[500] flex flex-col gap-2 font-[16px] leading-[1.5em]" dangerouslySetInnerHTML={{ __html: description }}></ul>
            </div>
