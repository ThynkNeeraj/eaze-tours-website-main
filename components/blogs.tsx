...
export default function Blogs() {
    ...
    return (
        <>
            <div className="mt-[78px] sm:mt-[165px] mx-8 mb-12 max-w-[1280px] w-full px-4">
            ...
            <div className="relative max-w-[1280px] mx-8 h-[480px] rounded-[23px] overflow-hidden flex items-center justify-start p-[20px] sm:p-[80px] bg-cover bg-center"
