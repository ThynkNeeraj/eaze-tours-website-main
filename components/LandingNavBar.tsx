    ...
    return (
        <div className="fixed top-0 left-0 w-full z-50">
            ...
            <div className="hidden sm:block">
                <div
                    className={`text-white h-[57px] py-[14px] px-[65px] font-urbanist md:flex justify-center transition-all duration-300 ${isScrolled ? "bg-black shadow-lg" : "bg-transparent"}`} style={{ display: displayStyle }}
                >
                ...
                >
                    ...
                    <div className="md:hidden flex items-center pr-3 relative z-50">
                        <button onClick={() => setIsMenuOpen(!isMenuOpen)} className="">
                            <i className={`fas ${isMenuOpen ? "fa-times  text-[#025C7A]" : "fa-bars text-[#6E9753]"} text-xl`} />
                        </button>
                    </div>
                    ...
                    <div className="navbar-end md:flex px-4 hidden">
                        <Link href="/contact" passHref>
                            ...
                            >
                                ...
                                <span className={`relative w-8 h-8 flex items-center justify-center rounded-full border border-white ${isScrolled ? "bg-[#fff]" : "bg-transparent"}`}>
                                    <i className={`fas fa-arrow-right text-lg ${isScrolled ? "text-[#025C7A]" : "text-[#fff]"}`} />
                                </span>
